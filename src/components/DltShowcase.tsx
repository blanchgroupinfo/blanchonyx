...
const NODES = Array.from({ length: 22 }).map((_, i) => {
  ...
  const y = perLayer === 1 ? 50 : 18 + (idxInLayer / (perLayer - 1)) * 64;
...
const DltShowcase = () => {
  ...
  return (
    <section
      id="dlt"
      className="dlt-section section-block-py-24 md:py-32 relative overflow-hidden section-pattern"
    >
      <div className="section-shell-absolute inset-0 bg-gradient-sacred pointer-events-none" />
