...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden section-pattern">
      ...
      <div className="container mx-auto px-6 py-24 relative z-10">
        ...
        >
          ...
          >
            <img
              alt="Blanch Onyx"
              className="w-32 h-32 md:w-40 md:h-40 object-contain border-0 border-transparent"
              src={BlanchLogoBrownAnimated}
            />
          </motion.div>
          ...
          >
            <span className="text-gradient-gold text-yellow-400">
              Blanch Onyx
            </span>
          </motion.h1>
          ...
          >
            Social Club manage by Blanch Group a Sovereign Trust
          </motion.p>
          ...
          >
            Blanch Onyx is a private membership Social Club, Distributed Ledger
            Technology (DLT) & network focused on elite collaboration, cultural
            leadership, strategic networking, and philanthropic development. Its
            managed by the Blanch Group A Sovereign Investment and Indigenous
            Tribal Association Trust—an irrevocable, tax-exempt charitable
            entity focused on technology research, financial technology
