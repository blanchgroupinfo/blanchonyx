...
const ethicalStandards = [
  { icon: Ban, text: "No Alcohol, Tobacco, or Illegal Substances" },
  { icon: Ban, text: "No Violence, War, or Weapons" },
  { icon: Ban, text: "No Biological Confusion or Species Mixing" },
  { icon: Wheat, text: "Clean Foods & Non-GMO Only" },
];
