...
const visionPoints = [
  ...
  {
    icon: Sparkles,
    title: "S.H.I.E.L.D. AI Media Content Generation",
    description:
...
const Vision = () => {
  return (
    <section className="py-24 md:py-32 relative section-pattern">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-lg text-white">
            We are not competitors—we are bssridge builders, encouraging
            collaboration, unity, and advancement. Our mission is to uphold
            Divine Law, foster truth, prosperity, peace, and to prepare a
            foundation for Holy Days, Feasts, and the Sabbath.
          </p>
        </motion.div>
        ...
        >
          <blockquote className="max-w-2xl mx-auto">
            <p className="font-display text-2xl md:text-3xl text-foreground/90 italic leading-relaxed mb-4">
              "As Elders and descendants of a Royal Priesthood, we honor
              Sovereign Divine Law above all worldly law, pursuing Peace /
              Shalawam / Shalam."
            </p>
