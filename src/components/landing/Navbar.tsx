...
const NAV_GROUPS = [
  {
    ...
    { label: "Smart City", href: "/vision", isRoute: true },
	  ...
	  { label: "Zero Knowledge Protocol", href: "/zero-knowledge", isRoute: true },
    ],
  },
  {
    label: "Membership",
  ...
  },
  {
    label: "Finance",
    links: [
	    { label: "Asset Bridge", href: "/asset-bridge", isRoute: true },
      { label: "Asset Vault", href: "/asset-vault", isRoute: true },
      ...
      { label: "SWIFT Migration", href: "/swift-migration", isRoute: true },
      { label: "Tokens", href: "/tokens", isRoute: true },
	    { label: "Tokenize Assets", href: "/tokenize-assets", isRoute: true },
      { label: "Tokens Explorer", href: "/tokens-explorer", isRoute: true },
   ...
   },
   {
    ...
    links: [
      ...
      { label: "Marketplace", href: "/marketplace", isRoute: true },
	    { label: "Metaverse", href: "/metaverse", isRoute: true },
	    { label: "Tokens", href: "/tokens", isRoute: true },
	    { label: "Tokenize Assets", href: "/tokenize-assets", isRoute: true },
      { label: "Tokens Explorer", href: "/tokens-explorer", isRoute: true },
	    { label: "TPS Live", href: "/tps", isRoute: true },
  ...
  },
  {
    ...
    links: [
      { label: "Affiliate Program", href: "/affiliate", isRoute: true },
	    ...
	    { label: "Solutions Overview", href: "/solutions", isRoute: true },
    ],
  },
];
