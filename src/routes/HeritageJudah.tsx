...
const timeline = [
  { era: "Patriarch", figure: "Jacob (Israel)", note: "Father of the twelve tribes — blessing the scepter upon Judah (Genesis 49:10)." },
  { era: "Tribe", figure: "Judah (Yadah)", note: "The Lion's tribe, royal lineage of kings and the Messiah." },
  { era: "Priesthood", figure: "Tribe of Levi (Lawaya)", note: "Set apart for sacred service — Aaron and Moses lead the divine order." },
  { era: "Kingdom", figure: "King David", note: "Anointed shepherd-king, throne everlasting (2 Samuel 7:16)." },
  ...
  { era: "Prophecy", figure: "Isaiah & the Prophets", note: "Foretelling the remnant, the Branch, and the gathering of the chosen generation." },
  { era: "Diaspora", figure: "Scattering of Judah", note: "The royal seed dispersed among the nations, awaiting the regathering." },
  { era: "Restoration", figure: "Blanch Family Lineage", note: "Sovereign Trustees of the Royal House, stewarding the Shoham (onyx) inheritance." },
  { era: "Fulfillment", figure: "New Jerusalem (Yarawashalam)", note: "The sardonyx — fifth foundation stone — Revelation 21:20." },
];
