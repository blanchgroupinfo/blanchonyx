...
import { ArrowLeft, Coins, TrendingUp, Shield, Zap, Globe, Lock, Activity, Crown, ShieldCheck, Scale } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-6 py-12 pt-24">
          ...
          <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8, delay: 0.2 }}>
            ...
            <div className="relative flex items-center justify-center">
              ...
              <motion.div
                animate={{ scale: [1, 1.05, 1], opacity: [0.7, 1, 0.7] }}
                transition={{ duration: 3, repeat: Infinity }}
                className="w-40 h-40 rounded-full bg-gradient-to-br from-primary/80 to-primary/20 border-4 border-primary/40 flex flex-col items-center justify-center relative z-10 p-4"
                style={{ boxShadow: "0 0 60px rgba(197,165,90,0.3)" }}
              >
                <img src={LOGO_BROWN} alt="Blanch Onyx Logo" className="h-9 w-auto mb-1.5 object-contain" referrerPolicy="no-referrer" />
                <p className="font-heading text-2xl text-primary-foreground">BOX</p>
                <p className="text-[10px] tracking-[0.2em] text-primary-foreground/70 uppercase">Blanch Onyx</p>
              </motion.div>
            </div>
        ...
        {/* Kingdom Reserve & Sovereign Attributes */}
        <div className="border border-border/40 bg-card p-8 md:p-12 relative overflow-hidden mb-16">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary/5 rounded-full blur-3xl pointer-events-none" />
          <div className="max-w-5xl mx-auto relative z-10">
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                {
                  title: "Reserve of the Kingdom",
                  desc: "The reserve coin of the Royal Priesthood — used for trade, settlement, and tithe across the Blanch Onyx Ecosystem.",
                  icon: Crown,
                },
                {
                  title: "Sovereign Backing",
                  desc: "Backed by heritage land, member enterprises, and the irrevocable Blanch Group Trust.",
                  icon: ShieldCheck,
                },
                {
                  title: "Universal Acceptance",
                  desc: "Accepted across Universal Business Networks, the Virtual Marketplace, and Smart City corridors.",
                  icon: Globe,
                },
                {
                  title: "Righteous Issuance",
                  desc: "Minted under Council oversight — no inflation by decree, no mining waste.",
                  icon: Scale,
                },
              ].map((item, idx) => (
                <div key={idx} className="border border-border/20 bg-background/40 p-6 flex flex-col justify-between hover:border-primary/40 transition-all duration-300">
                  <div>
            ...
            {/* Scripture Quote */}
            <div className="border-t border-border/20 pt-8 text-center max-w-xl mx-auto">
              <p className="font-display italic text-base md:text-lg text-primary tracking-wide mb-2">
                "Honour the Most High AHAYAH with thy substance, and with the firstfruits of all thine increase."
              </p>
      ...
      {/* Utilities */}
      <section className="vision-section section-block mt-24">
        <div className="section-shell">
          <div className="vision-heading">
            <p className="eyebrow"><span />BOX Coin Utility</p>
            <h2>
              Sovereign Ecosystem &<br />
              <em>digital empowerment.</em>
            </h2>
            <p>Six core utilities driving membership, governance, and commerce on the DLT.</p>
          </div>
          <div className="vision-grid mt-12">
            {[
              { icon: Shield, title: "Governance Voting", desc: "Stake BOX to participate in sovereign governance proposals on S.H.I.E.L.D. AI." },
              { icon: Globe, title: "Blanch Corridor Commerce", desc: "Power all trade, services, and exchanges within the Blanch Corridor ecosystem." },
              { icon: Lock, title: "Membership Payments", desc: "Pay for all membership tiers, upgrades, and Black Card services with BOX." },
              ...
              >
                <span>0{i + 1}</span>
                <p className="mini-label">BOX Utility</p>
                <h3 className="font-heading">{u.title}</h3>
                <p>{u.desc}</p>
