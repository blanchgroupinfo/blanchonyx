...
const layers = [
  {
    ...
    hebrew: "א",
    desc: "Aleph — divine origin of value, the breath of liquidity.",
  },
  {
    n: "2",
    name: "Identity & Accounts",
    hebrew: "ב",
    desc: "Bet — the house, sovereign identity of every account.",
  },
  {
    n: "3",
    name: "Logistics & Trade",
    hebrew: "ג",
    desc: "Gimel — movement, the camel of righteous trade.",
  },
  {
    n: "4",
    name: "Access Gateway",
    hebrew: "ד",
    desc: "Dalet — the door, gateway to sovereign networks.",
  },
  {
    n: "5",
    name: "Analytics & Insight",
    hebrew: "ה",
    desc: "Heh — revelation through holy intelligence.",
  },
  {
    n: "6",
    name: "Connection Mesh",
    hebrew: "ו",
    desc: "Vav — the nail, binding sovereign nodes.",
  },
  {
    n: "7",
    name: "Security & Audit",
    hebrew: "ז",
    desc: "Zayin — sword of protection, audit, and finality.",
  },
  {
    n: "8",
    name: "Storage Ledger",
    hebrew: "ח",
    desc: "Chet — sacred enclosure, immutable storage.",
  },
];
...
const features = [
  {
    icon: Layers,
    title: "8-Layer DAG",
    desc: "Parallel directed-acyclic-graph architecture for infinite scalability.",
  },
  { icon: Cpu, title: "22 Sacred Nodes", desc: "Functions mapped to the Ancient Hebrew alphabet." },
  {
    icon: Lock,
    title: "No Fees · No Mining",
    desc: "Righteous consensus without exploitation or waste.",
  },
  {
    icon: Globe,
    title: "22.5 Quadrillion TPS+∞",
    desc: "Throughput engineered for the global Royal Priesthood.",
  },
];
...
export const Route = createFileRoute('/dlt')({
  component: DLTPage,
});
